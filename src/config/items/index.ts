...
export const ITEMS: Item[] = [
  ...
  { id: 'crosse-de-fusil', name: 'Crosse de Fusil', category: 'armesDeCorpsACorps', image: IMG + 'melee/butt_stock.png', range: '1', damage: 'F/3', properties: 'Contondant', techLevel: 'III' },
